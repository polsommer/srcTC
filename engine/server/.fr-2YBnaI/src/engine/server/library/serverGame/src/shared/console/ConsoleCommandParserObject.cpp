...
static const CommandParser::CmdInfo cmds[] =
{
	...
	{"moveToPlayer",                    2, "<oid> <playerOID>",          "Move anw object to a player"},
	...
	{"setAdminTitle",                   1, "<0=none, 1=csr, 2=dev,  3=dno,  4=qa>",     "Set your development title 0=none, 1=csr, 2=dev, 3=dno, 4=qa"},
	...
	else if (isCommand(argv[0], "setAdminTitle"))
	{
		...
		switch(which)
		{
			...
			case 2:
				...
				break;
                        case 3:
				playerObject->setPriviledgedTitle(static_cast<int8>(PlayerDataPriviledgedTitle::Contributer));
				break;
			case 4:
