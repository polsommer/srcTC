...
void Chat::createSystemRooms(const std::string & galaxyName, const std::string & planetName)
{
	...
	createRoom(avatarName, true, gamePrefix + ChatRoomTypes::ROOM_CHAT,     "public chat for all galaxies, can create rooms here");                          		createRoom(avatarName, true, gamePrefix + ChatRoomTypes::ROOM_GALAXY, "public chat for the whole galaxy, cannot create rooms here");
