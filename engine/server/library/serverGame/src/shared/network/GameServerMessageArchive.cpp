...
void GameServerMessageArchive::pack(Archive::ByteStream &target, const AiCreatureStateMessage &msg)
{
...
void GameServerMessageArchive::pack(Archive::ByteStream &target, const AiMovementMessage &msg)
{
	Archive::put(target, msg);
}
