...
void FloatingPointUnit::install(void)
{
    ...
    // Enable exceptions based on configuration
    setExceptionEnabled(E_precision, ConfigSharedFoundation::getFpuExceptionPrecision());
    setExceptionEnabled(E_underflow, ConfigSharedFoundation::getFpuExceptionUnderflow());
    setExceptionEnabled(E_overflow, ConfigSharedFoundation::getFpuExceptionOverflow());
    setExceptionEnabled(E_zeroDivide, ConfigSharedFoundation::getFpuExceptionZeroDivide());
    setExceptionEnabled(E_denormal, ConfigSharedFoundation::getFpuExceptionDenormal());
    setExceptionEnabled(E_invalid, ConfigSharedFoundation::getFpuExceptionInvalid());
...
void FloatingPointUnit::setExceptionEnabled(Exception exception, bool enabled)
{
    ...
    // Set or clear the exception bit as appropriate
    if (enabled)
        status &= ~bits;
    else
        status |= bits;
