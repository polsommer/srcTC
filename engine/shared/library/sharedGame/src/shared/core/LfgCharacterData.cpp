...
namespace LfgCharacterDataNamespace
{
	...
	std::string const s_stat_klaatu(s_stat_species_section + ".klaatu");
	std::string const s_stat_chiss(s_stat_species_section + ".chiss");
	std::string const s_stat_nikto(s_stat_species_section + ".nikto");
	std::string const s_stat_ishitib(s_stat_species_section + ".ishitib");
	...
	std::string const s_stat_nightsister_m(s_stat_species_gender_section + ".nightsister_m");
	std::string const s_stat_togruta_f(s_stat_species_gender_section + ".togruta_f");
	std::string const s_stat_togruta_m(s_stat_species_gender_section + ".togruta_m");
	...
	std::string const s_stat_klaatu_m(s_stat_species_gender_section + ".klaatu_m");
	std::string const s_stat_klaatu_f(s_stat_species_gender_section + ".klaatu_f");
	...
	std::string const s_stat_nikto_f(s_stat_species_gender_section + ".nikto_f");
	std::string const s_stat_nikto_m(s_stat_species_gender_section + ".nikto_m");
	std::string const s_stat_ishitib_m(s_stat_species_gender_section + ".ishitib_m");
	std::string const s_stat_ishitib_f(s_stat_species_gender_section + ".ishitib_f");
	std::string const s_stat_nautolan_m(s_stat_species_gender_section + ".nautolan_m");
	std::string const s_stat_nautolan_f(s_stat_species_gender_section + ".nautolan_f");
	std::string const s_stat_weequay_m(s_stat_species_gender_section + ".weequay_m");
	std::string const s_stat_weequay_f(s_stat_species_gender_section + ".weequay_f");
	std::string const s_stat_arcona_m(s_stat_species_gender_section + ".arcona_m");
	std::string const s_stat_arcona_f(s_stat_species_gender_section + ".arcona_f");
	std::string const s_stat_devaronian_f(s_stat_species_gender_section + ".devaronian_f");
...
std::string LfgCharacterData::getDebugString() const
{
	...
	if (species == SharedCreatureObjectTemplate::SP_bothan)
		...
		output += "Marauder";
	else if (species == SharedCreatureObjectTemplate::SP_klaatu)
		output += "Klaatu";
...
std::map<std::string, int> const & LfgCharacterData::calculateStatistics(std::map<NetworkId, LfgCharacterData> const & connectedCharacterLfgData)
{
	...
	if (statistics.empty())
	{
		...
		statistics[s_stat_klaatu] = 0;
		statistics[s_stat_chiss] = 0;
		statistics[s_stat_ishitib] = 0;
        ...
        statistics[s_stat_nightsister_m] = 0;
        statistics[s_stat_nightsister_f] = 0;
        statistics[s_stat_togruta_m] = 0;
        statistics[s_stat_togruta_f] = 0;
        statistics[s_stat_bith_m] = 0;
        statistics[s_stat_bith_f] = 0;
        statistics[s_stat_nikto_m] = 0;
        statistics[s_stat_nikto_f] = 0;
        statistics[s_stat_marauder_m] = 0;
        statistics[s_stat_marauder_f] = 0;
        statistics[s_stat_klaatu_m] = 0;
        statistics[s_stat_klaatu_f] = 0;
        statistics[s_stat_chiss_m] = 0;
        statistics[s_stat_chiss_f] = 0;
        statistics[s_stat_ishitib_m] = 0;
        statistics[s_stat_ishitib_f] = 0;
        statistics[s_stat_nautolan_m] = 0;
        statistics[s_stat_nautolan_f] = 0;
        statistics[s_stat_weequay_m] = 0;
        statistics[s_stat_weequay_f] = 0;
        statistics[s_stat_arcona_m] = 0;
        statistics[s_stat_arcona_f] = 0;
        statistics[s_stat_devaronian_m] = 0;
        statistics[s_stat_devaronian_f] = 0;
	...
	for (std::map<NetworkId, LfgCharacterData>::const_iterator iterLfgData = connectedCharacterLfgData.begin(); iterLfgData != connectedCharacterLfgData.end(); ++iterLfgData)
	{
		...
		else if (iterLfgData->second.species == SharedCreatureObjectTemplate::SP_nightsister)
		{
			...
			if (iterLfgData->second.gender == SharedCreatureObjectTemplate::GE_male)
				++(statistics[s_stat_nightsister_m]);
			else if (iterLfgData->second.gender == SharedCreatureObjectTemplate::GE_female)
		...
		else if (iterLfgData->second.species == SharedCreatureObjectTemplate::SP_klaatu)
		{
			++(statistics[s_stat_klaatu]);

			if (iterLfgData->second.gender == SharedCreatureObjectTemplate::GE_male)
				++(statistics[s_stat_klaatu_m]);
			else if (iterLfgData->second.gender == SharedCreatureObjectTemplate::GE_female)
				++(statistics[s_stat_klaatu_f]);
		}
		...
		{
			++(statistics[s_stat_ishitib]);

			if (iterLfgData->second.gender == SharedCreatureObjectTemplate::GE_male)
				++(statistics[s_stat_ishitib_m]);
			else if (iterLfgData->second.gender == SharedCreatureObjectTemplate::GE_female)
				++(statistics[s_stat_ishitib_f]);
		}
		...
		else if (iterLfgData->second.species == SharedCreatureObjectTemplate::SP_devaronian)
		{
			...
			if (iterLfgData->second.gender == SharedCreatureObjectTemplate::GE_male)
				...
				++(statistics[s_stat_devaronian_f]);
		}
