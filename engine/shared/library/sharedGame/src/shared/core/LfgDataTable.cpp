...
namespace LfgDataTableNamespace
{
    ...
    bool matchSpeciesKlaatu(LfgCharacterData const & lfgCharacterData, void const *, void const *, void const *, void const *, void const *)
    	{
    		return (lfgCharacterData.species == SharedCreatureObjectTemplate::SP_klaatu);
    	}
...
void LfgDataTable::install()
{
	...
	mapInternalSearchAttributeMatchFunction["klaatu"] = matchSpeciesKlaatu;
	mapInternalSearchAttributeMatchFunction["chiss"] = matchSpeciesChiss;
	mapInternalSearchAttributeMatchFunction["ishitib"] = matchSpeciesIshitib;
