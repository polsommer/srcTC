...
private:
	CompilerIntegerParam m_gender;		// //creature gender
	CompilerIntegerParam m_niche;		// //creature niche
	CompilerIntegerParam m_species;		// //creature species
	CompilerIntegerParam m_race;		// //creature subspecies
...
inline void SharedCreatureObjectTemplate::install(void)
{
//@BEGIN TFD INSTALL
