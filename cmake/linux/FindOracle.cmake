...
# CMake expects the first argument to match the original find_package()
# invocation.  The module historically used the uppercase ORACLE name
# instead, which triggers a developer warning in recent CMake versions.
# Use the mixed-case Oracle identifier so `find_package(Oracle ...)`
# consumers avoid the noisy warning while keeping backward-compatible
# cache variables.
find_package_handle_standard_args(Oracle DEFAULT_MSG ORACLE_LIBRARY ORACLE_INCLUDE_DIR)

# Preserve the legacy `ORACLE_FOUND` variable expected by the existing
# build scripts while also providing the standard `Oracle_FOUND` symbol
# generated by find_package_handle_standard_args above.
set(ORACLE_FOUND ${Oracle_FOUND})
