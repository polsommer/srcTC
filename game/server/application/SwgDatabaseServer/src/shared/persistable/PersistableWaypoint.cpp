...
// Only defined on Win32 for compatibility
#ifdef WIN32
bool PersistableWaypoint::operator!=(const PersistableWaypoint& rhs) const
{
...
namespace Archive
{
    ...
    {
        // Deserialize fields in a 32-bit friendly manner
    ...
    {
        // Serialize fields in a 32-bit friendly manner
